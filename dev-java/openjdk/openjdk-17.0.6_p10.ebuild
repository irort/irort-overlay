...
IUSE="alsa big-endian cups debug doc examples headless-awt +idea javafx +jbootstrap selinux source system-bootstrap systemtap"
...
src_prepare() {
	use amd64 && use idea && eapply "${FILESDIR}"/openjdk-17-idea.patch
