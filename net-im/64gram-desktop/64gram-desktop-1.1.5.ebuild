...
# and =net-im/64gram-1.1.5.ebuild from sunset-repo overlay
...
DESCRIPTION="Unofficial desktop client for Telegram"
HOMEPAGE="https://github.com/TDesktop-x64/tdesktop"

MY_P="64Gram-${PV}-full"
SRC_URI="https://github.com/TDesktop-x64/tdesktop/releases/download/v${PV}/${MY_P}.tar.gz"
S="${WORKDIR}/${MY_P}"
...
PATCHES=(
	"${FILESDIR}/64gram-1.0.99-qt_compare.patch"
	"${FILESDIR}/64gram-1.1.5-fix-lzma-link.patch"
...
src_prepare() {
	...
	#eapply --binary "${FILESDIR}/tdesktop-4.10.5-qt_compare.patch"
...
pkg_preinst() {
	# Change telegram to 64gram
	mkdir -pv "${ED}"/usr/share/64Gram/externalupdater.d || die
	echo "/usr/bin/telegram-desktop" > "${ED}"/usr/share/64Gram/externalupdater.d/telegram-desktop.conf || die
	xdg_pkg_preinst
}
